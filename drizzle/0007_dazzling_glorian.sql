...
ALTER TABLE "proposal_approvals" DROP CONSTRAINT IF EXISTS "proposal_approvals_attachment_file_id_proposal_files_id_fk";
--> statement-breakpoint
ALTER TABLE "proposal_comments" DROP CONSTRAINT IF EXISTS "proposal_comments_file_id_proposal_files_id_fk";
--> statement-breakpoint
ALTER TABLE "proposal_versions" DROP CONSTRAINT IF EXISTS "proposal_versions_file_id_proposal_files_id_fk";
--> statement-breakpoint
